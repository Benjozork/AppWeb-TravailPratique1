...
class StoresFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'user_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => 'owner', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2020-10-19 23:59:15',
                'modified' => '2020-10-19 23:59:15',
            ],
        ];
        parent::init();
    }
